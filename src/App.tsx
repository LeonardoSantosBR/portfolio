    ...
    <>
      ...
      <header className="header">
        <div className="container header__inner">
          <a href="#top" className="logo">Leo<span className="logo__accent">/&gt;</span></a>
      ...
      <main>
        ...
        <section id="experiencia" className="section container"><div className="section__head"><span className="badge">experiência</span><h2 className="section__title">Trajetória profissional</h2></div><div className="timeline">{experiences.map((experience) => <div className="timeline-item" key={experience.org}><div className="timeline-item__top"><span className="timeline-item__role">{experience.role}</span><span className="timeline-item__period">{experience.period}</span></div><div className="timeline-item__org"><img src={experience.logo} alt="" className="timeline-item__org-logo" /><span>{experience.org}</span></div><div className="timeline-item__location">{experience.location}</div><ul className="timeline-item__list">{experience.bullets.map((bullet) => <li key={bullet}>{bullet}</li>)}</ul></div>)}</div></section>
